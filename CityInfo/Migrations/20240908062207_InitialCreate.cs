    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CityObjectTypes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GisOsmBuildingId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomBuildings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustomBuildings_gis_osm_buildings_a_free_1_GisOsmBuildingId",
                        column: x => x.GisOsmBuildingId,
                        principalTable: "gis_osm_buildings_a_free_1",
                        principalColumn: "gid",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CityObjectTypeId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EntranceData", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EntranceData_CustomBuildings_CustomBuildingModelId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomBuildings_GisOsmBuildingId",
                table: "CustomBuildings",
                column: "GisOsmBuildingId");

            migrationBuilder.CreateIndex(
                name: "IX_EntranceData_CustomBuildingModelId",
                table: "EntranceData",
